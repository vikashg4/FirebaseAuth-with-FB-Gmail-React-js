...
<div
    ...
    <Form onSubmit={handleSubmit}>
      <Container>
        <Typography sx={{ marginBottom: "30px",color:'black' ,marginTop:'-100px'  }} variant="h4" component="h1">
          Create account
        </Typography>
  ...
  <Typography variant="h6" color={'black'} textAlign={'left'}> Password</Typography>
       <PasswordInput
        ...
        <Link component={RouterLink} to="/sign-in">
          <Typography variant="h6" sx={{color:'black',marginTop:2}}>Already have an account? Log in here!</Typography>
        </Link>
      </Container>
    </Form>
